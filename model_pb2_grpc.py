...
class FinancialModelStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDataHead = channel.unary_unary(
                '/FinancialModel/GetDataHead',
                request_serializer=model__pb2.Empty.SerializeToString,
                response_deserializer=model__pb2.DataHead.FromString,
                _registered_method=True)
        self.Predict = channel.unary_unary(
                '/FinancialModel/Predict',
                request_serializer=model__pb2.Empty.SerializeToString,
                response_deserializer=model__pb2.PredictionResponse.FromString,
                _registered_method=True)


class FinancialModelServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FinancialModelServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'FinancialModel', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('FinancialModel', rpc_method_handlers)
...
class FinancialModel(object):
    ...
    def GetDataHead(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            model__pb2.DataHead.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
